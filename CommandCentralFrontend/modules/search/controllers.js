    ...
    .controller('SearchByFieldPrintController',
        ['$scope', '$filter', '$rootScope', '$location', '$routeParams', 'AuthenticationService', 'AuthorizationService', 'SearchService', 'ConnectionService', 'config',
            function ($scope, $filter, $rootScope, $location, $routeParams, AuthenticationService, AuthorizationService, SearchService, ConnectionService, config) {
                ...
                $scope.moveToTop = function (selectedField) {
                    var currentIndex = $scope.searchByFieldReturns.indexOf(selectedField);
                    $scope.searchByFieldReturns.splice(currentIndex, 1);
                    $scope.searchByFieldReturns.unshift(selectedField);

                };

                $scope.moveUp = function (selectedField) {
                    var currentIndex = $scope.searchByFieldReturns.indexOf(selectedField);
                    $scope.searchByFieldReturns.splice(currentIndex-1, 2, $scope.searchByFieldReturns[currentIndex], $scope.searchByFieldReturns[currentIndex-1]);

                };

                $scope.moveDown = function (selectedField) {
                    var currentIndex = $scope.searchByFieldReturns.indexOf(selectedField);
                    $scope.searchByFieldReturns.splice(currentIndex, 2, $scope.searchByFieldReturns[currentIndex+1], $scope.searchByFieldReturns[currentIndex]);

                };

                $scope.moveToBottom = function (selectedField) {
                    var currentIndex = $scope.searchByFieldReturns.indexOf(selectedField);
                    $scope.searchByFieldReturns.splice(currentIndex, 1);
                    $scope.searchByFieldReturns.push(selectedField);
